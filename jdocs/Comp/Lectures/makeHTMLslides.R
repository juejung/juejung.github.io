...
setwd("C:/Dropbox/Towson/Teaching/3_ComputationalEconomics/Lectures")

myDir = "C:/Dropbox/Towson/Teaching/3_ComputationalEconomics/Lectures/"
i = "CourseStructure"
...
markdownToHTML(j_out1,j_out2,
               stylesheet='C:/Dropbox/Towson/Teaching/3_ComputationalEconomics/Lectures/jcss.css')
...
# system("pandoc  -t s5 -s -m --mathml Slides10_Cake.md -o Slides10_Cake.html")
...
markdownToHTML(j_out1,j_out2,
               stylesheet='C:/Dropbox/Towson/Teaching/3_ComputationalEconomics/Lectures/jcss.css')
# # make beamer slides
# myDirtemp = paste(myDir, 'Lecture11/Slides',sep="")
# setwd(myDirtemp)
...
# markdownToHTML(j_out1, j_out2,
#                stylesheet='C:/Dropbox/Towson/Teaching/3_ComputationalEconomics/Lectures/jcss.css')# creates .md ->  .html file
